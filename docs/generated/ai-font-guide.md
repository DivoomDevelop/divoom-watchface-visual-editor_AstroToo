...
> 自动生成于 `2026-06-08T02:00:40.642Z`，数据源 `public/font/font_info.cfg`。
> 共 **161** 款字体：矢量 TTF **127** 款，位图字图集 **34** 款。
...
| 362 | vector_ttf | Font 362 | — | 通用可读 |
| 364 | vector_ttf | Font 364 | — | 通用可读 |
| 366 | vector_ttf | Font 366 | — | 通用可读 |
| 368 | vector_ttf | Font 368 | — | 通用可读 |
